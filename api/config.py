...
API_TITLE: str = os.getenv("API_TITLE", "Trading Bot API")
API_VERSION: str = os.getenv("API_VERSION", "1.0.0")
API_DESCRIPTION: str = os.getenv("API_DESCRIPTION", "Production-ready backend for a multi-market trading platform")
...
DATA_SOURCES = {
    "crypto_price": "binance",          
    "crypto_onchain": "glassnode",
